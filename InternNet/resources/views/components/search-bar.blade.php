<form action="{{ route('search') }}" method="GET" class=" my-12">
    ...
    <div class="relative">
        ...
        <input type="search" name="query" id="default-search" class="w-full p-5 pl-10 text-md text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Intitulé du poste, mots-clés..." required />
